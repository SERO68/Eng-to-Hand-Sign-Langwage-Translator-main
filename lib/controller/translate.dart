...
void TranslateToSign() {
  ...
  for (int i = 0; i < charList.length; i++) {
    final character = charList[i].toUpperCase();
    final matchingSign = handsignsMap.firstWhere(
      (element) => element.containsKey(character),
      orElse: () => {'unknown': 'assets/signlangwage/unknown.jpg'}, // Provide a fallback image
    );
    showsigns[i] = matchingSign;
  }
